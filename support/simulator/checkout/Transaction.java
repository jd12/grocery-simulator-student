...
public final class Transaction {
	...
	/**
	 * Creates a {@link Transaction} for with the specified receipt at the specified startTime, for the specified
	 * shopper taking the specified time of transaction
